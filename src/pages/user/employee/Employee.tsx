...
export const Employee: React.FC = () => {
    ...
    const filteredItems = currentItems.filter((item) => {
        return search.trim() === '' ? item : (item.sName ? item.sName : '').includes(search);
    });
                                                ...
                                                {empData.length > 0 ? (
                                                    <tbody className='bg-tbody'>
                                                        {filteredItems.length > 0 ? (
                                                                ...
                                                                return (
                                                                    <tr role='row' className='odd' key={index}>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            >
                                                                                {item.bIsActive ? (
                                                                                    <FontAwesomeIcon icon={faCircleCheck} color='white' className='icon' />
                                                                                ) : (
                                                                            ...
                                                                            >
                                                                                <FontAwesomeIcon icon={faTrash} color='white' /> <span>Delete</span>
                                                                            </Button>
                                                                        </td>
                                                                    </tr>
                                                                );
                                                            ...
                                                            <tbody className="bg-tbody">
                                                                <tr style={{ width: '100vw' }} className="notfound">
                                            ...
                                            <div className='d-flex justify-content-between align-items-center'>
                                                ...
                                                {empData.length > 0 ? (
                                                    ...
                                                    <div className='dataTables_paginate paging_simple_numbers' id='DataTables_Table_0_paginate'>
                                                        ...
                                                        <span>
                                                            <Button className='paginate_button-current' aria-controls='DataTables_Table_0' data-dt-idx={1} tabIndex={0}>
                                                                {currentPage + 1}
                                                            </Button>
                                                        </span>
                                                        <Button
