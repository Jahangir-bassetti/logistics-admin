...
export const Bill: React.FC = () => {
  ...
  const totalPages = Math.ceil(billData.length / recordSize);
  // const apiUrl = process.env.REACT_APP_LOCAL_API_URL!;
  const startIndex = currentPage * recordSize;
  const endIndex = startIndex + recordSize;
  const currentItems = billData.slice(startIndex, endIndex);
  ...
  const data = [
    {
      "Invoice_No": "3245",
      "Invoice_Date": "27/02/2003",
      "Sage_Code": "CME12",
      "Client_Name": "Jahangir",
      "Address": "Kolakta",
      "Invoice_Total": "767345",
    },
    {
      "Invoice_No": "3245",
      "Invoice_Date": "27/02/2003",
    ...
    <>
      ...
      <Container fluid style={{ opacity: showModal ? "0.4" : "1" }}>
        <div className="user-content-header py-4">
          ...
          <Row className="mb-2">
            <Col sm="6">
              <h1 className="m-0 text-dark">Bills</h1>
            </Col>
            <Col sm="6">
                    ...
                    <div style={{ overflow: "auto" }}>
                              ...
                              .map((item, index) => {
                                return (
                                  <tr role="row" className="odd" key={index}>
                                    ...
                                    <td>{item.Invoice_Total ? item.Invoice_Total : "----"}</td>
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        >
                          ...
                          {endIndex < billData.length
                            ? endIndex
                            : billData.length}{" "}
                          of {billData.length} entries
                        </div>
                        {billData.length > 0 ? (
                          <div
